...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v5.2.6/actionpack/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v5.2.6/actionpack" } if s.respond_to? :metadata=
